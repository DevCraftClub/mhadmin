 ...
 */
$logsSaveTypesDescr = __('Какие типы записывать в файл, БД и Telegram:')
                     . '<ul>'
                     . __('<li><b>Все</b> — сохранять все типы логов</li>')
                     . __('<li><b>Ошибки</b> — только ошибки</li>')
                     . __('<li><b>Информация</b> — только info</li>')
                     . __('<li><b>Уведомления</b> — только notice</li>')
                     . __('<li><b>Предупреждения</b> — только warning</li>')
                     . __('<li><b>Критические ошибки</b> — только critical</li>')
                     . __('<li><b>Отладка</b> — только debug</li>')
                     . '</ul><br>'
                        ...
                        ->section(__('Общие'))
	                        ...
	                        ->number('cache_timer', __('Время хранения кеша'))
		                        ->description(
			                        ...
			                        . __('<b><i>По умолчанию: 1440 минут (1 сутки)</i></b>'),
		                        )
		                        ->filter(FILTER_VALIDATE_INT)
		                        ->default(1440)
...
//		                        ->default(false)
		                ...
		                ->section(__('Логирование'))
	                        ...
	                        ->multi('logs_save_types', __('Тип сохраняемых логов'))
		                        ->description($logsSaveTypesDescr)
		                        ->options([
			                        'all'      => __('Все'),
			                        'error'    => __('Ошибки'),
			                        'info'     => __('Информация'),
