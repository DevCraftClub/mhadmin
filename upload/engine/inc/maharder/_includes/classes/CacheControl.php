...
abstract class CacheControl {
	 ...
	 *
	 * @throws JsonException|Throwable Если произошла ошибка при декодировании JSON.
	 */
	...
	public static function clearCache(string|array $type = 'all'): void {
		...
		if ($type === 'all') {
			...
			foreach (MhTranslation::getLanguages() as $lang) {
				@unlink(DataManager::normalizePath(sprintf("%s/assets/js/i18n/translation.%s.js", MH_ADMIN, $lang['tag'])));
			}
			return;
		}
