...
trait DleData {
	...
	/**
	 * Возвращает список категорий в виде ассоциативного массива, где ключом является ID категории, а значением — вся информации о категории.
	 *
	 * Метод загружает данные из базы данных, используя метод `load_data`, и сортирует их по названию категории в
	 * алфавитном порядке. В результате возвращается массив с ID категорий в качестве ключей и названиями категорий в
	 * качестве значений.
	 *
	 * @return array Ассоциативный массив категорий, где ключ — ID категории, а значение — вся информации о категории.
	 * @throws JsonException
	 * @see DataLoader::load_data() Для загрузки данных из базы данных
	 */
	public function getFullCats(): array {
		$cats       = $this->load_data("category", [
			'order'   => ['name' => 'ASC']
		]);
		$categories = [];
