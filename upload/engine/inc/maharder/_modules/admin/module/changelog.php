...
$logs = [
	'180.3.5' => [
		...
		__('[UPDATE] Обновлена функция перевода __ для JS. Теперь можно выводить перевод с параметрами. параметры указываются подобным видом: <code>:title:</code>'),
		__('[FIX] Исправление функции <code>joinPaths</code> класса DataManager'),
		__('[FIX] Исправление ошибки в сохранении данных ассетов'),
	],
	'173.3.4' => [
